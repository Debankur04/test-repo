...
document.getElementById("confirmpassword-signup").addEventListener("input", () => {
    regPass = document.getElementById("password-signup").value;
    regconfPass = document.getElementById("confirmpassword-signup").value;
    if(isPassword(regPass))
    {
...
function togglePasswordvisibility()
{
    ...
    document.getElementById("SeePwdReg").classList.contains("hidden") ? document.getElementById("password-signup").setAttribute("type", "password") : document.getElementById("password-signup").setAttribute("type", "text");
    document.getElementById("SeePwdConf").classList.contains("hidden") ? document.getElementById("confirmpassword-signup").setAttribute("type", "password") : document.getElementById("confirmpassword-signup").setAttribute("type", "text");
}
setInterval(() => {
